...
CPPFLAGS ?=
LDFLAGS ?=
DEPS = server.h request.h constants.h mime.h list.h hashmap.h log.h config.h cache.h helpers.h
OBJ = srv.o server.o request.o mime.o list.o hashmap.o log.o config.o cache.o
RM = rm -f
